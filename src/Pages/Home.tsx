        ...
        <Paper id='home-1' elevation={3} sx={{width: '100vw', height: '27vh', borderRadius: '0'}}>
          ...
          <Grid2 container spacing={0} sx={{display: 'flex', justifyContent: 'center', alignItems:'center', width: '100%', height: '100%'}}>
              <Box sx={{
                  ...
                  zIndex: 2}}>
                <VideoItem sx={{width: '100%', height: '100%', objectFit: 'cover', zIndex: 1}} videoUrl={videoUrl} isMobile={isMobile}/>
              </Box>
          </Grid2>
        </Paper>
              ...
              <Grid2 id='ticket-2' size={4} position='relative'>
                <Box sx={{ width: '100%', height: '100%', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center'}}>
                  ...
                  <Box id='ticket-content-2' position='absolute' flexWrap='nowrap' zIndex={2} sx={{width: '80%', height: '100%', display:'flex',flexDirection:'column', justifyContent:'center', alignItems:'center'}} >
                    ...
                    <Box sx={{width: '80%', height: 'auto'}}>
                      <Typography textAlign='center' color='white' sx={{fontSize: '1.7cqw', fontWeight: 'bold', marginBottom:'calc(.5vw + .5vh)', textWrap: 'nowrap'}}>3rd Party Operators</Typography>
                    </Box>
                    <Box sx={{width: '80%', height: 'auto'}}>
